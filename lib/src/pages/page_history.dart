...
class PageHistoryWidget extends StatefulWidget {
  dynamic currentTab;
...
class _PagesTestWidgetState extends State<PageHistoryWidget> {
  initState() {
    super.initState();
  ...
  @override
  void didUpdateWidget(PageHistoryWidget oldWidget) {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        drawer: DrawerWidget(),
        body: OrdersHistoryWidget(parentScaffoldKey: widget.scaffoldKey),
      ),
    );
  }
