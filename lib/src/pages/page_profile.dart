...
class _PagesTestWidgetState extends State<PageProfileWidget> {
  initState() {
    super.initState();
  ...
  @override
  void didUpdateWidget(PageProfileWidget oldWidget) {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        drawer: DrawerWidget(),
        body:  ProfileWidget(parentScaffoldKey: widget.scaffoldKey),
      ),
    );
  }
