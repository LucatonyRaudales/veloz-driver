...
import 'src/pages/page_history.dart';
import 'src/pages/page_orders.dart';
import 'src/pages/page_profile.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/PageOrders':
        return MaterialPageRoute(builder: (_) => PageOrdersWidget());
      case '/PageProfile':
        return MaterialPageRoute(builder: (_) => PageProfileWidget());
       case '/PageHistory':
        return MaterialPageRoute(builder: (_) => PageHistoryWidget());
      case '/CurrentMap':
